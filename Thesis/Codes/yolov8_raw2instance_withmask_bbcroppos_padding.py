...
if results[0].masks is not None:
    for mask in results[0].masks.masks.cpu().numpy():
        ...
        padded_image, padded_mask = add_padding_with_transparency(image_crop, mask_crop.convert("L"), 0.3)
